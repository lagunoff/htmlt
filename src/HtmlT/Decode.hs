...
-- | Extract data of type @a@ out of 'JSVal'. Similar to decoders from
-- Elm core library. Typicaly they will be used to parse information
-- from DOM events (like mouse coordinates, keyboard keys, input
-- values etc)
