...
ZC1ZChtmltzm0zi1zi0zi0zminplaceZCClickableziFFIZC: ($1,$2) => {console.log(new TextDecoder('utf8').decode(new Uint8Array(__exports.memory.buffer, $1, $2)));},
ZC3ZChtmltzm0zi1zi0zi0zminplaceZCClickableziFFIZC: ($1) => ((a1) => __exports.ghczuwasmzujsffiZC2ZChtmltzm0zi1zi0zi0zminplaceZCClickableziFFIZC($1,a1)),
ZC4ZChtmltzm0zi1zi0zi0zminplaceZCClickableziFFIZC: ($1,$2,$3,$4) => {var e = new TextDecoder('utf8').decode(new Uint8Array(__exports.memory.buffer, $2, $3));   if ($1 instanceof Comment) {     $1.parentNode.addEventListener(e, $4);   } else {     $1.addEventListener(e, $4);   }},
ZC5ZChtmltzm0zi1zi0zi0zminplaceZCClickableziFFIZC: () => (document.body),
ZC6ZChtmltzm0zi1zi0zi0zminplaceZCClickableziFFIZC: ($1,$2,$3,$4,$5) => {var k = new TextDecoder('utf8').decode(new Uint8Array(__exports.memory.buffer, $2, $3));   var v = new TextDecoder('utf8').decode(new Uint8Array(__exports.memory.buffer, $4, $5));   if ($1 instanceof Comment) {     $1.parentNode[k] = v;   } else {     $1[k] = v;   }},
ZC7ZChtmltzm0zi1zi0zi0zminplaceZCClickableziFFIZC: ($1,$2,$3) => {$1.nodeValue = new TextDecoder('utf8').decode(new Uint8Array(__exports.memory.buffer, $2, $3));},
ZC8ZChtmltzm0zi1zi0zi0zminplaceZCClickableziFFIZC: ($1,$2,$3) => {var t = new TextDecoder('utf8').decode(new Uint8Array(__exports.memory.buffer, $2, $3));   var n = document.createElement(t);   if ($1 instanceof Comment) {     $1.parentNode.insertBefore(n, $1);   } else {     $1.appendChild(n);   }   return n;},
ZC9ZChtmltzm0zi1zi0zi0zminplaceZCClickableziFFIZC: ($1,$2,$3) => {var c = new TextDecoder('utf8').decode(new Uint8Array(__exports.memory.buffer, $2, $3));   var n = document.createTextNode(c);   if ($1 instanceof Comment) {     $1.parentNode.insertBefore(n, $1);   } else {     $1.appendChild(n);   }   return n;},
