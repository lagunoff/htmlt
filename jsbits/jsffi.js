...
ZC0ZChtmltzm0zi1zi0zi0zminplaceZCHtmlTziSketchziFFIZC: ($1,$2) => {console.log(new TextDecoder('utf8').decode(new Uint8Array(__exports.memory.buffer, $1, $2)));},
ZC2ZChtmltzm0zi1zi0zi0zminplaceZCHtmlTziSketchziFFIZC: ($1) => ((a1) => __exports.ghczuwasmzujsffiZC1ZChtmltzm0zi1zi0zi0zminplaceZCHtmlTziSketchziFFIZC($1,a1)),
ZC3ZChtmltzm0zi1zi0zi0zminplaceZCHtmlTziSketchziFFIZC: ($1,$2,$3,$4) => {var e = new TextDecoder('utf8').decode(new Uint8Array(__exports.memory.buffer, $2, $3));   $1.addEventListener(e, $4);},
ZC4ZChtmltzm0zi1zi0zi0zminplaceZCHtmlTziSketchziFFIZC: () => (document.body),
ZC5ZChtmltzm0zi1zi0zi0zminplaceZCHtmlTziSketchziFFIZC: ($1,$2,$3,$4,$5) => {var k = new TextDecoder('utf8').decode(new Uint8Array(__exports.memory.buffer, $2, $3));   var v = new TextDecoder('utf8').decode(new Uint8Array(__exports.memory.buffer, $4, $5));   $1[k] = v;},
ZC6ZChtmltzm0zi1zi0zi0zminplaceZCHtmlTziSketchziFFIZC: ($1,$2,$3) => {$1.nodeValue = new TextDecoder('utf8').decode(new Uint8Array(__exports.memory.buffer, $2, $3));},
ZC7ZChtmltzm0zi1zi0zi0zminplaceZCHtmlTziSketchziFFIZC: ($1,$2,$3) => {var t = new TextDecoder('utf8').decode(new Uint8Array(__exports.memory.buffer, $2, $3));   var n = document.createElement(t);   $1.appendChild(n);   return n;},
ZC8ZChtmltzm0zi1zi0zi0zminplaceZCHtmlTziSketchziFFIZC: ($1,$2,$3) => {var c = new TextDecoder('utf8').decode(new Uint8Array(__exports.memory.buffer, $2, $3));   var n = document.createTextNode(c);   $1.appendChild(n);   return n;},
